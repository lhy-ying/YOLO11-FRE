...
class VanillaNet(nn.Module):
    def __init__(self, factor=0.5, in_chans=3, num_classes=1000, dims=[96, 192, 384, 768],
...
def vanillanet_5(factor, **kwargs):
    model = VanillaNet(factor=factor, dims=[128 * 4, 256 * 4, 512 * 4, 1024 * 4], strides=[2, 2, 2], **kwargs)
    return model
...
if __name__ == '__main__':
    model = vanillanet_5(factor=0.25)
