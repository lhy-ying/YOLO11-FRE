...
__all__ = [ 'CSWin_64_12211_tiny_224', "CSWin_64_24322_small_224", "CSWin_96_24322_base_224", "CSWin_144_24322_large_224"]
...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self,factor=0.5, depth_factor=0.5, img_size=640, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2, 2, 6, 2],
                 split_size=[3, 5, 7],
...
def CSWin_64_24322_small_224(factor,depth_factor, **kwargs):
    model = CSWinTransformer(actor=factor, depth_factor=depth_factor,patch_size=4, embed_dim=64, depth=[2, 4, 32, 2],
                             split_size=[1, 2, 8, 8], num_heads=[2, 4, 8, 16], mlp_ratio=4., **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model
